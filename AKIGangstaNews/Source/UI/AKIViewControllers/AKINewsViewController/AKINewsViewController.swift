...
class AKINewsViewController: AKIAbstractViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    let cellReuseIdentifier = "AKINewViewCell"
    ...
    override func viewDidLoad() {
        ...
        self.fillArray()
        self.newsView?.tableView?.register(AKINewViewCell.self, forCellReuseIdentifier: self.cellReuseIdentifier)
        self.loadContext()
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.headerLabel?.text = "ddsadadadadadsdsdsdsdsdsdsdsdsdsdsdsdsdsdsdsd"
        cell.logoImage?.image = UIImage(named: "logonews")
